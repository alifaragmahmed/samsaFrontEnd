...
/* harmony import */ var _components_control_report_control_report_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./components/control-report/control-report.component */ "./src/app/academic/components/control-report/control-report.component.ts");
/* harmony import */ var _components_doctor_doctor_index_doctor_index_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./components/doctor/doctor-index/doctor-index.component */ "./src/app/academic/components/doctor/doctor-index/doctor-index.component.ts");
/* harmony import */ var _components_open_course_open_course_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./components/open-course/open-course.component */ "./src/app/academic/components/open-course/open-course.component.ts");
/* harmony import */ var _components_student_register_course_student_register_course_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./components/student-register-course/student-register-course.component */ "./src/app/academic/components/student-register-course/student-register-course.component.ts");
/* harmony import */ var _components_student_result_index_student_result_index_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./components/student-result-index/student-result-index.component */ "./src/app/academic/components/student-result-index/student-result-index.component.ts");
...
var routes = [
    ...
    {
        path: 'open-course',
        component: _components_open_course_open_course_component__WEBPACK_IMPORTED_MODULE_7__["OpenCourseComponent"]
    },
    {
        path: 'student-register-course',
        component: _components_student_register_course_student_register_course_component__WEBPACK_IMPORTED_MODULE_8__["StudentRegisterCourseComponent"]
    },
    {
        path: 'doctors',
        component: _components_doctor_doctor_index_doctor_index_component__WEBPACK_IMPORTED_MODULE_6__["DoctorIndexComponent"]
    },
    {
        path: 'student-result',
        component: _components_student_result_index_student_result_index_component__WEBPACK_IMPORTED_MODULE_9__["StudentResultIndexComponent"]
    },
    {
        path: 'control-report',
        component: _components_control_report_control_report_component__WEBPACK_IMPORTED_MODULE_5__["ControlReportComponent"]
    },
    {
        path: '**',
        redirectTo: '/',
...
var StudentRegisterCourseComponent = /** @class */ (function () {
    ...
    StudentRegisterCourseComponent.prototype.printRegisterCourses = function () {
        var url = src_environments_environment__WEBPACK_IMPORTED_MODULE_9__["environment"].publicUrl + "/academic/register-course-print/" + this.student.id + "?api_token=" + src_app_shared_auth__WEBPACK_IMPORTED_MODULE_5__["Auth"].getApiToken();
        src_app_shared_helper__WEBPACK_IMPORTED_MODULE_7__["Helper"].openWindow(url);
    };
