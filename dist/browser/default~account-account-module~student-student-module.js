...
var PaymentDetailsReportComponent = /** @class */ (function () {
    ...
    PaymentDetailsReportComponent.prototype.loadAcadeimicYearExpenses = function () {
        ...
        var data = {
            ...
            levels: this.selectedLevels.getKeys()
        };
        this.acadeimicYearExpenseService.getDetails(data).subscribe(function (res) {
            _this.academicYearExpenses = res;
            //
            _this.loadPayments();
        });
    };
